...
namespace Funfik.Web.Areas.Default.Controllers
{
    public partial class HomeController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string About = "~/Areas/Default/Views/Home/About.cshtml";
            public readonly string Contact = "~/Areas/Default/Views/Home/Contact.cshtml";
            public readonly string Index = "~/Areas/Default/Views/Home/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Funfik.Web.Areas.Default.Controllers.HomeController
    {
